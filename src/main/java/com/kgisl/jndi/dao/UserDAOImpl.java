...
public class UserDAOImpl implements UserDAO {
    ...
    @Override
    public List<User> getResultsByList(List<Integer> ids) {
    	String sql="CALL GetResultsByList(?)";
    	Object[] parameters= {ids};
        return jdbcTemplate.query(sql, new BeanPropertyRowMapper<>(User.class), parameters);
    }
